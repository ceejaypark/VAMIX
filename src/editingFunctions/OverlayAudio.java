...
public class OverlayAudio {
	...
	private class overlaySwingWorker extends SwingWorker<Integer,String>{
		...
		protected Integer doInBackground() throws Exception {		
			...
			ProcessBuilder builder = new ProcessBuilder("/bin/bash", "-c","avconv -i" + _inputVideo + " -strict experimental -i " + _inputAudio + " -strict experimental -filter_complex amix=inputs=2:duration=first:dropout_transition=3 " + outputName);			_userInfo.setText("Overlay of audio is in progress...");
			Process process = builder.start();
			_userInfo.setText("Overlay in progress...");
